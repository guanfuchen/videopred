...
from data_utils import SequenceGenerator, MovingMnistGenerator
...
# 训练数据生成器和校准数据生成器
train_generator = MovingMnistGenerator(train_file, train_sources, nt, batch_size=batch_size, shuffle=True)

...
def load_dataset():
    ...
    return load_mnist_images('/home/cgf/Data/pytorch/train-images-idx3-ubyte.gz')

# generates and returns video frames seqs*seq_len*(shape)*3
def generate_moving_mnist_batch(shape=(64,64), seq_len=30, seqs=4, num_sz=28, nums_per_image=2):
    mnist = load_dataset()
    width, height = shape

...
def main():
    convlstm = ConvLSTMCell(2, 1, (3, 5), stride=1, padding=(0, 1))
    x = Variable(torch.ones(1, 2, 22, 22))
    h = Variable(torch.ones(1, 1, 20, 20))
    c = Variable(torch.ones(1, 1, 20, 20))
    t = Variable(torch.zeros(1, 1, 20, 20))
